            ...
            <div className="flex  flex-col-reverse md:flex-row">
              ...
              <div className="lg:w-1/2 w-full">
                ...
                <p className=" mt-8 text-xl lg:text-2xl leading-10 lg:-ml-5">
                  Our services include iteration planning, test-driven
                  development and iterative processes for your mobile, web or
            ...
            <div className="flex flex-col md:flex-row">
              <div className="lg:w-1/2 w-full">
                ...
                <p className=" mt-8 text-xl lg:text-2xl leading-10">
                  ...
                  that have been conceptualized or being developed to make it
                  meet the market demands and expectations.
                </p>
              </div>
              <div className="lg:w-1/2 w-full flex justify-center items-center ">
                <img
