    ...
    <footer className=" pt-10 sm:mt-10 footerBackground">
      <div className="max-w-6xl m-auto text-black-800 flex flex-wrap justify-left">
        <div className="p-10 w-full sm:w-8/12 md:w-6/12 lg:-mt-8">
          ...
          />
          <div className="uppercase  text-6xl primaryColorText font-sans font-normal tracking-wide subpixel-antialiased">
            systems
          </div>
        ...
        <div className="p-5  w-full md:w-3/12">
          ...
          >
            ...
            <address className="capitalize">
              No 21,University permanentsite road Ilorin, Kwara State, Nigeria.
            </address>
          </a>
          <a
        ...
        >
          <p>
            ...
            <a
              ...
              className="primaryColorText ml-1"
              target="_blank"
            >
          ...
          <div className="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start ">
              <a className="primaryColorText hover:text-gray-500">
                <svg
                  fill="currentColor"
                  strokeLinecap="round"
              ...
              <a className="ml-3 primaryColorText  hover:text-gray-500">
                <svg
                  fill="currentColor"
                  strokeLinecap="round"
                  strokeLinejoin="round"
