  ...
  return (
    <div classNames="h-auto relative">
      ...
      <div
        ...
        style={{
          background:
            " linear-gradient( #00438bd5, #00438bd5), url(/hero-bg-2.jpg)",
